...
- **v1 (이상거래 탐지모델)**: 공개된 SAP ERP 데이터(BKPF, BSEG, LFA1, SKA1)를 결합해 구성한
...
- **RAG를 추가한 이유**: LLM이 근거 없이 그럴듯한 설명을 만들어내는 환각 위험을
...
- 검색은 임베딩 기반 의미 검색이 아니라 TF-IDF 기반이라, 관련 조항을
